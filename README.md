...
| Documentation | Public workflow guide, data schema, manuscript-to-code mapping, supplementary method notes, changelog and citation metadata. |
...
| Manuscript mapping | 2-5 min | Where each manuscript concept appears in this repository. | [docs/manuscript_mapping.md](docs/manuscript_mapping.md) |
...
| [docs/](docs/) | Public workflow, data schema and manuscript-to-code mapping. |
